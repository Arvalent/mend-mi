...
max_length = 47
tokenizer = load(open("image_description/files/tokenizer.p","rb"))


interpreter = tf.lite.Interpreter("image_description/files/model-110.tflite")
...
x_interpreter = tf.lite.Interpreter("image_description/files/xception.tflite")
